...
- [ ] Step 0.5(⇒回执: .claude/state/self-correct.json): 跑 `/self-correct` — 拿 `app/rules/build-constraints.md` 8 约束对成品自省(证据强度/直译/以用户走全程/主次/可玩性等),自纠 + 把"需真机/用户"项带进本次 not_verified
